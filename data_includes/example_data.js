...
PennController.FeedItems( PennController.GetTable( "SW-datasource-DiscFam.csv" ).setLabel("Expt"),//.filter("Expt","experiment"),
    (item) => PennController(
        ...
        newCanvas("answerbox", 800, 150)
            .settings.add(25,45, newText("labelLeft", "Det är troligt").settings.size(700, 30).settings.bold() )  
            .settings.add(170,40, getScale("answer").settings.size(200, 0) )
            .settings.add(400,45, newText("labeRight", "inte troligt,").settings.size(700, 30).settings.bold() )
